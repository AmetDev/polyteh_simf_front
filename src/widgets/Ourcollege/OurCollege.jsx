...
import mainImg from './image_2024-12-03_14-18-10.png'
import style from './OurCollege.module.scss'
import secondImg from './photo_2024-02-12_17-39-05.jpg'
...
const OurCollege = () => {
	return (
		<main className={style.our__colleage}>
			...
			<Link className={style.our__colleage__link} href='/achives'>
				Наши достижения
			</Link>
		</main>
	)
